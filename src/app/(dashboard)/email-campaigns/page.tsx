            ...
            <div className="space-y-6 py-2">
                ...
                <div className="space-y-4 rounded-2xl border border-zinc-850 bg-zinc-950/30 p-4">
                    ...
                    <div className="grid grid-cols-2 rounded-xl border border-zinc-800 bg-zinc-950 p-1">
                      <button
                        ...
                        className={`flex items-center justify-center gap-1.5 rounded-lg px-3 py-2 text-xs font-bold transition-all ${
                          templateBuilderMode === 'AI' ? 'bg-purple-500 text-white' : 'text-zinc-500 hover:text-zinc-300'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`flex items-center justify-center gap-1.5 rounded-lg px-3 py-2 text-xs font-bold transition-all ${
                          templateBuilderMode === 'MANUAL' ? 'bg-emerald-500 text-white' : 'text-zinc-500 hover:text-zinc-300'
                        }`}
                      >
                  ...
                  {templateBuilderMode === 'AI' ? (
                    <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                      <div>
                        <label className="block text-[10px] text-zinc-500 mb-1">Goal</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-[10px] text-zinc-500 mb-1">Audience</label>
                        <input
                          type="text"
              ...
              <div className="rounded-2xl border border-zinc-850 bg-zinc-950 p-4 shadow-xl">
                <div className="flex flex-col gap-3 border-b border-zinc-850 pb-4 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <p className="text-xs font-bold uppercase tracking-wider text-purple-400">Email Preview</p>
                    <p className="mt-1 text-xs text-zinc-500">Review the selected or newly created template before choosing recipients.</p>
                  </div>
                ...
                {previewTemplate ? (
                  ...
                  <div className="mt-4 flex h-64 items-center justify-center rounded-2xl border border-dashed border-zinc-800 bg-zinc-900/30 text-center">
                    <div>
                      ...
                      <p className="mt-3 text-sm font-bold text-zinc-400">No template selected</p>
                      <p className="mt-1 text-xs text-zinc-600">Select a saved template, generate one with AI, or write one manually.</p>
                    </div>
                  </div>
                )}
              </div>
